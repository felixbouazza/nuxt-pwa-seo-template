<template>
  <div>
    ...
    <div class="flex items-center justify-center w-full mb-8 mt-2">
      <svg width="24" height="24" viewBox="0 0 24 24">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 24 24"
    ...
    <!-- DIV TITRE COLONES -->
    <div class="flex justify-between mx-2 my-2 border">
      <p>DOCUMENTATION</p>
      <p>ENABLE</p>
    </div>
