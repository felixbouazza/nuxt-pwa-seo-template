    ...
    computed: {
        ...
        filteredCryptoList() {
            ...
            return this.cryptoList.filter(crypto => {
                return crypto.title.toLowerCase().includes(this.cryptoSearch.toLowerCase())
            })
        }
    },
    async fetch() {
