<template>
    <div class="flex flex-row px-3 justify-between h-12">
      ...
      <div class="flex flex-row bg-white dark:bg-sidebarContentBackgroundDark mx-2 my-2 rounded-md h-8">
        <svg class="fill-current dark:text-iconColorDark mx-2 my-1" width="24" height="24" viewBox="0 0 24 24">
          <path
            data-name="search-Filled"
            class="cls-1"
            d="m21.707 20.293-4.539-4.539a8.527 8.527 0 1 0-1.414 1.414l4.539 4.539a1 1 0 0 0 1.414-1.414ZM4 10.5a6.5 6.5 0 1 1 6.5 6.5A6.508 6.508 0 0 1 4 10.5Z"
          />
        </svg>
        <input
          v-model="cryptoSearch"
          @input="triggerSearch"
          class="dark:text-iconColorDark dark:bg-sidebarContentBackgroundDark outline-none w-2/4 text-sm lg:text-base"
          type="text"
