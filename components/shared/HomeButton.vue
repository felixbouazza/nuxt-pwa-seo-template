<template>
    <button @click="goHome" class="flex flex-row fill-current dark:text-iconColorDark items-center">
...
export default {
    computed: {
        ...mapState(["cryptoListActive", "isSettingsSidebar"]),
    },
    methods: {
        ...mapMutations(["switchNavbar", "displayCryptoList"]),
        goHome() {
